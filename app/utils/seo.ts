...
export const metadata: Metadata = {
  ...
  // Basic
  title: {
    default: 'แคลมป์รัดท่อไฮดรอลิก แคลมป์ท่อ DIN 3015 ราคาโรงงาน | JTL Hydraulic',
    template: '%s | JTL Hydraulic',
  },
  description:
    'แคลมป์รัดท่อไฮดรอลิก (แคล้มรัดท่อ / ไฮดรอลิค) แคลมป์ท่อ Pipe Clamp คุณภาพสูง มาตรฐาน DIN 3015 ทั้งพลาสติกและอลูมิเนียม รุ่น Standard และ Heavy ครบทุกขนาด Ø6–168 mm ราคาโรงงาน จัดส่งทั่วประเทศ',
  keywords: [
